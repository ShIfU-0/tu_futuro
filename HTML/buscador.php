...
<head>
    ...
    <link rel='stylesheet' type='text/css' media='screen' href='mnu.css'>
...
<?php
    ...
    <thead>
        <tr>
            <th colspan="6"><a href="/tu_futuro/HTML/bucador.html">NUEVA BUSQUEDA</a></th>
        </tr>
		<tr>
 ...
 <?php
    ...
    <table>
        <thead>
            <tr>
             ...
             <tr>
            <th>Num de Respuestas<?php echo $row['id_res'];?></th>
            </tr>  
    ...
    ?>
    <a href="resultados1.php">Descarga tu PDF</a>
    </table>
 </section>
