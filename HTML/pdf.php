...
use Dompdf\Dompdf; //para incluir el namespace  de la libreria 
$dompdf = new Dompdf(); //crear el objeto de la clase 
?>
   ...
   <section id="conten">
    ...
    <table>
        <thead>
            ...
            <tr>
            <th>id respuestas<?php echo $row['id_res'];?></th>
            </tr>
            </thead>
...
<?php
$html= ob_get_clean();
//anadir el html a domnpdf
$dompdf->loadHtml($html);

//establecer el tamano de la hoja en dompdf
$dompdf->setPaper('A4', 'portrail');

//renderiza el pdf
$dompdf->render();

//forrzar la descarga del pdf o abrirlo en un html aparte 
$dompdf->stream("usuarios_pdf.pdf", [ "Attachment" => false]);
?>